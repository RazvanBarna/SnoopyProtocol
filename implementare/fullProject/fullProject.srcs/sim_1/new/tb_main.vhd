...
signal clk,btnRst,full,empty,start,DONE,modify_state_out,DONE_GET_OUT,NEW_FIFO_OUT,WB_FOR_WB : std_logic :='0';
...
signal data_in_fifo_debug,DATA_FROMCC_TOTABLE_GET : std_logic_vector(65 downto 0) :=(others =>'0');
